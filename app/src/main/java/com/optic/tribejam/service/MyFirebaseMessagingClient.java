package com.optic.tribejam.service;
...
import com.optic.tribejam.channel.NotificationHelper;
import com.optic.tribejam.models.Message;
import com.optic.tribejam.receivers.MessageReceiver;
...
public class MyFirebaseMessagingClient extends FirebaseMessagingService {
    ...
    //Obtenemos la imagen de perfil de Emisor, transformandola de json a bitmap
    ...
    //Obtenemos la imagen de perfil de Receptor, transformandola de json a bitmap
    ...
    private void notifyMessage(Map<String, String> data, Bitmap bitmapSender, Bitmap bitmapReceiver) {
        ...
        final NotificationCompat.Action action = new NotificationCompat.Action.Builder(
                ...
                .build();
        //Transformacion de notifivcacion a json
        Gson gson = new Gson();
