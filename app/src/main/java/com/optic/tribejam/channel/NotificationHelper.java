package com.optic.tribejam.channel;
...
//Metodo de configuracion de la Notificacion

public class NotificationHelper  extends ContextWrapper {
    private static final String CHANNEL_ID = "com.optic.tribejam";
    private static final String CHANNEL_NAME = "TribeJam";
    ...
    public NotificationCompat.Builder getNotificationMessage(
        ...
        if (bitmapReceiver == null) {
            person1 = new Person.Builder()
                    ...
                    .setIcon(IconCompat.createWithResource(getApplicationContext(), R.drawable.ic_person_))
                    .build();
        }
        else {
            person1 = new Person.Builder()
